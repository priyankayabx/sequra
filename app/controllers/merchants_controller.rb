class MerchantsController < ApplicationController
  ...
  private
    ...
    def merchant_params
      params.require(:merchant).permit(:name, :email_id, :total_commission_charged, :disbursement_frequency, :live_on, :min_monthly_fee, :status)
    end

   

    def total_commission_charged(merchant_id)
      return 9
    end
end
